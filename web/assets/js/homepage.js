...
function addToCart(id, name, price) {
    ...
    $("#shopcart").append("<div id='order" + count + "' class='card animated bounceInUp  light-blue lighten-5'><div class='card-content black-text'><a class='right-align' href='#' onclick='eraseCart(" + id + ", " + count + ", " + price + ")'><i class='material-icons right white'>close</i></a><h4>" + name + "</h4><input type='hidden' name='id" + count + "' value='" + id + "'><div class='row'><div class='input-field'><select name='jumlah" + count + "' onchange='changeQuantity(" + id + ", this)'required><option value='0' selected disabled>Jumlah</option><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option><option value='5'>5</option></select><input type='text' name='keterangan" + count + "' placeholder='Keterangan'></div></div></div></div>");
    disableButton(id);
    addItem(id, 0, price);
    increaseCount();
